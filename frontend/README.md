...
4. Asegurate de tener instalado [Angular 10.1.4](https://github.com/angular/angular-cli). Si no, instalar.
5. Ejecutar en terminal: ```npm install```
6. Ejecutar `ng serve` para servidor de desarrollo. Navega  a `http://localhost:4200/`.



## Soporte Navegadores

Soporta las ultimas versiones de los navegadores:
